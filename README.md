# IgA Nephropathy Knowledge Graph

This pipeline creates a BioCypher knowledge graph from the clinicaltrials.gov
REST API for IgA Nephropathy.

## ⚙️ Installation (local, for docker see below)

```{bash}
git clone https://github.com/biocypher/igan.git
cd igan
poetry install
